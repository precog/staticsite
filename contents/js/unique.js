...
$(document).ready(function(){
      ...
      if (currentLocation == "/account/") {
            ...
            if (userLoggedIn) {
                  ...
                  var precogApi = new Precog.api({"apiKey": userApiKey, "analyticsService" : "https://beta.precog.com"});
                  ...
                  $("#precog-create-apikey").submit(function(e){
                      ...
                      if (formName.length < 1 || formDescription.length < 3 || formPath.length < 3) {
                          ...
                          $('input:checked').each(function() {
                              ...
                              grantPermissions.push({ accessType: grantType, path: formPath, ownerAccountIds: [userAccountID]});
                          });
